package com.my.kuaidi.admin.common.config;
...
@MapperScan(basePackages =
        {"com.my.kuaidi.admin.**.mapper"
        ,"com.my.kuaidi.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.my.kuaidi.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            "com.my.kuaidi.admin.model," +
            "com.my.kuaidi.admin.rmp.model," +
            "com.my.kuaidi.model";//逗号分隔多个
