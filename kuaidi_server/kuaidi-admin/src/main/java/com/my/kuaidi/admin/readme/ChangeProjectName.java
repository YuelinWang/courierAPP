package com.my.kuaidi.admin.readme;


import com.my.kuaidi.core.common.file.FileHelper;
...
public class ChangeProjectName {
    private static String[] source = {"com.my.youyamvc","youyamvc"};//com.my.youyamvc youyamvc
